...
<div class="ttq-step-head">
	<h3><?php esc_html_e( 'Review Your Specifications', 'ttq' ); ?></h3>
	<p class="ttq-sub"><?php esc_html_e( 'Please review the details you selected for your quote/sample below.', 'ttq' ); ?></p>
</div>

<!-- Two callout info boxes -->
<div class="ttq-review-callouts">
	<div class="ttq-callout ttq-callout--info">
		<span class="ttq-callout__icon" aria-hidden="true">
			<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
		</span>
		<div>
			<strong><?php esc_html_e( 'Please review the details you selected for your quote/sample below.', 'ttq' ); ?></strong>
		</div>
	</div>
	<div class="ttq-callout ttq-callout--neutral">
		...
		<div>
			<strong><?php esc_html_e( 'If you need to make any changes,', 'ttq' ); ?></strong>
			<p><?php esc_html_e( 'click "Back" to edit your selections.', 'ttq' ); ?></p>
		</div>
	</div>
	<div class="ttq-callout ttq-callout--success">
		<span class="ttq-callout__icon" aria-hidden="true">
		...
		<div>
			<strong><?php esc_html_e( 'If everything looks correct,', 'ttq' ); ?></strong>
			<p><?php esc_html_e( 'click "Request Samples & Quote Now!"', 'ttq' ); ?></p>
		</div>
	</div>
</div>

<!-- 3-column review grid (matches screenshot exactly) -->
<div class="ttq-review-grid">
	...
	<div class="ttq-review-card">
		<h4 class="ttq-review-card__title">
			...
			<?php esc_html_e( 'PRODUCT SELECTION', 'ttq' ); ?>
		</h4>
		...
		<dl class="ttq-review-dl">
			<div>
				<dt><?php esc_html_e( 'Selected Model', 'ttq' ); ?></dt>
				<dd data-review="product">&mdash;</dd>
			</div>
			<div>
				<dt><?php esc_html_e( 'Order Quantity', 'ttq' ); ?></dt>
			...
			<div>
				<dt><?php esc_html_e( 'Side 1 Stamping', 'ttq' ); ?></dt>
				<dd data-review="side1">&mdash;</dd>
			</div>
			<div>
				<dt><?php esc_html_e( 'Side 2 Stamping', 'ttq' ); ?></dt>
				<dd data-review="side2">&mdash;</dd>
			</div>
			<div>
				<dt><?php esc_html_e( 'Selected Color', 'ttq' ); ?></dt>
	...
	<div class="ttq-review-card">
		<h4 class="ttq-review-card__title">
			...
			<?php esc_html_e( 'CONTACT & NOTIFICATION', 'ttq' ); ?>
		</h4>
		...
		<dl class="ttq-review-dl">
			<div>
				<dt>
					...
					<?php esc_html_e( 'Contact Person', 'ttq' ); ?>
				</dt>
			...
			<div>
				<dt>
					...
					<?php esc_html_e( 'Notification Email', 'ttq' ); ?>
				</dt>
	...
	<div class="ttq-review-card">
		<h4 class="ttq-review-card__title">
			...
			<?php esc_html_e( 'DELIVERY ADDRESS', 'ttq' ); ?>
		</h4>

		<div class="ttq-review-address">
			<p data-review="address" class="ttq-review-address__text">&mdash;</p>
			<p data-review="organization" class="ttq-review-address__org ttq-hint"></p>
		</div>
...
<div class="ttq-nav-row">
	...
	<button type="button" class="ttq-btn ttq-btn--primary ttq-btn--cta ttq-js-submit">
		...
		<?php esc_html_e( 'Request Samples & Quote Now!', 'ttq' ); ?> <span aria-hidden="true">&rarr;</span>
	</button>
</div>
