...
<div class="ttq-overlay ttq-js-overlay" hidden aria-live="assertive" role="status">
	...
	<!-- Submitting state: ring circling a tick icon (client's "Option 1 / 6" style from the PDF). -->
	<div class="ttq-overlay__panel ttq-js-overlay-submitting">
		<div class="ttq-tick-spinner" aria-hidden="true">
			<svg viewBox="0 0 120 120" class="ttq-tick-spinner__ring">
			...
			<svg viewBox="0 0 64 64" class="ttq-tick-spinner__bug">
				...
				<g class="ttq-tick-spinner__legs">
					<line x1="20" y1="28" x2="6" y2="20" /><line x1="20" y1="36" x2="4" y2="36" /><line x1="20" y1="44" x2="6" y2="52" />
					<line x1="44" y1="28" x2="58" y2="20" /><line x1="44" y1="36" x2="60" y2="36" /><line x1="44" y1="44" x2="58" y2="52" />
				</g>
			</svg>
		</div>
	...
	<div class="ttq-overlay__panel ttq-js-overlay-success" hidden>
		...
		<p class="ttq-js-overlay-success-message"><?php esc_html_e( 'Thanks for helping keep our communities safe and tick smart! Our team will follow up with your quote shortly.', 'ttq' ); ?></p>
		<button type="button" class="ttq-btn ttq-btn--primary ttq-js-overlay-close"><?php esc_html_e( 'Done', 'ttq' ); ?></button>
	</div>
	...
	<div class="ttq-overlay__panel ttq-js-overlay-error" hidden>
		...
		<button type="button" class="ttq-btn ttq-btn--ghost ttq-js-overlay-close"><?php esc_html_e( 'Close', 'ttq' ); ?></button>
	</div>
