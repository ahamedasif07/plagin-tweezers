...
class TTQ_Admin {
	...
	public function save_product_meta( $post_id ) {
		...
		$colors = isset( $_POST['ttq_colors'] ) && is_array( $_POST['ttq_colors'] ) ? array_map( 'sanitize_key', $_POST['ttq_colors'] ) : array();
		update_post_meta( $post_id, '_ttq_colors', implode( ',', $colors ) );

		$sizes = isset( $_POST['ttq_sizes'] ) && is_array( $_POST['ttq_sizes'] ) ? array_map( 'sanitize_key', $_POST['ttq_sizes'] ) : array();
